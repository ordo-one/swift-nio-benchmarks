...
final class ByteBufferReadWriteMultipleIntegersBenchmark<I: FixedWidthInteger>: NIOBenchmark {
...
final class ByteBufferMultiReadWriteTenIntegersBenchmark<I: FixedWidthInteger>: NIOBenchmark {
    private let iterations: Int
    private var buffer: ByteBuffer = ByteBuffer()
